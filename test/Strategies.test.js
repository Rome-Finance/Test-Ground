...
contract('Strategy Tests', (accounts) => {
    ...
    describe('More Complex Strategy Simulation', async () => {
        ...
        it('test strategy changing value, gets smaller, ie loses money, non uniform deposits', async () => {
            let theEmpire = await PoolManager.new(accounts[0], "the empire", {
                from: accounts[0],
                gas: "1000000"
            }) //accounts[0] usually is deployer if you dont specify. I think it might just the the default for everything that would make sense
            ...
            //console.log(testPool.address)
            await theEmpire.depositToPool(testPool.address, 100000)
            await theEmpire.depositToPool(testPool.address, 200000, {from: accounts[1], gas: "2000000"})
            await theEmpire.depositToPool(testPool.address, 50000, {from: accounts[2], gas: "2000000"})
            await theEmpire.depositToPool(testPool.address, 350000, {from: accounts[3], gas: "2000000"})
            ...
            await j_store_it_strat_new.loseMoney(350000, {from: accounts[6], gas: "3000000"})

            await theEmpire.withdrawFromPool(testPool.address, 50000, {from: accounts[0], gas: "3000000"})
            await theEmpire.withdrawFromPool(testPool.address, 100000, {from: accounts[1], gas: "3000000"})
            await theEmpire.withdrawFromPool(testPool.address, 25000, {from: accounts[2], gas: "3000000"})
            await theEmpire.withdrawFromPool(testPool.address, 175000, {from: accounts[3], gas: "3000000"})
            ...
            bal = await romeTok.balanceOf(accounts[1])
            dprint("user2 " + bal)
            bal.should.be.a.bignumber.that.closeTo(new BN(900000), '10');
            ...
            bal = await romeTok.balanceOf(accounts[2])
            dprint("user3 " + bal)
            bal.should.be.a.bignumber.that.closeTo(new BN(975000), '10');
            ...
            bal = await romeTok.balanceOf(accounts[3])
            dprint("user3 " + bal)
            bal.should.be.a.bignumber.that.closeTo(new BN(825000), '10')

        })

        it('test strategy changing value, gets bigger, ie gains money, non uniform deposits', async () => {
            let theEmpire = await PoolManager.new(accounts[0], "the empire", {
                from: accounts[0],
                gas: "1000000"
            }) //accounts[0] usually is deployer if you dont specify. I think it might just the the default for everything that would make sense
            ...
            await romeTok.transfer(j_store_it_strat_new.address, 350000, {from: accounts[5], gas: "1000000"})
            ...
            bal = await romeTok.balanceOf(accounts[0])
            dprint("user2 " + bal)
            bal.should.be.a.bignumber.that.closeTo(new BN(1050000), '10');
            ...
            bal = await romeTok.balanceOf(accounts[2])
            dprint("user3 " + bal)
            bal.should.be.a.bignumber.that.closeTo(new BN(1025000), '10');
            ...
            bal = await romeTok.balanceOf(accounts[3])
            dprint("user3 " + bal)
            bal.should.be.a.bignumber.that.closeTo(new BN(1175000), '10')
